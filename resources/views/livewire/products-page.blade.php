        ...
        <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
            <div class="flex flex-wrap mb-24 -mx-3">
                ...
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200  ">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live="price_range" min="10" id="price_range"
                                class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                                max="1000" value="100" step="10">
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(10, 'USD') }}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(1000, 'USD') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full px-3 lg:w-3/4">
                    <div class="px-3 mb-4">
                        <div class="items-center justify-between hidden px-3 py-2 bg-blue-100 md:flex">
                            <div class="flex items-center justify-between">
                                <select wire:model.live='sort' 
                                    class="block w-40 text-base bg-blue-100 cursor-pointer text-blue-700">
                                    <option value="lates">Sort by latest</option>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                                <div class="border border-gray-300 ">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span
                                                class="text-green-600 ">{{ Number::currency($product->price), 'IDR' }}</span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-gray-300 ">

                                        <a wire:click.prevent='addToCart({{ $product->id }})' href="#"
                                            class="text-gray-500 flex items-center space-x-2  hover:text-red-500 ">
